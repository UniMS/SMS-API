...
| --- | ------ | ----------------------------------------- | ---------------------------------- | ------ |
| 1   | GET    | `/students`                               | Get all students                   | unfinished      |
| 2   | POST   | `/students`                               | Create a new student               | unfinished      |
...
| 6   | DELETE | `/students/:studentId`                    | Delete a student                   | unfinished      |
...
| 9   | PUT    | `/students/:parentId/parent`              | Update parent informtion           | new             |
...
| NO. | Method | Routes                                                                                               | Description                    | Remark      |
| --- | ------ | ---------------------------------------------------------------------------------------------------- | ------------------------------ | ----------- |
| 24  | GET    | `/gradings`                                                                                          | Get all gradings               | unfinished  |
| 25  | POST   | `/gradings/csv`                                                                                      | Create bulks gradings with csv | unfinished  |
| 26  | GET    | `/gradings/:gradingId`                                                                               | Get a grading                  | unfinished  |
| 27  | PUT    | `/gradings/:gradingId`                                                                               | Update a grading               | unfinished  |
| 28  | DELETE | `/gradings/:gradingId`                                                                               | Delete a grading               | unfinished  |
| 29  | GET    | `/gradings/academic-year/:academicYearId/roll-no/:rollNo/gpa`                                        | Get final year GPA             | new         |
| 30  | GET    | `/gradings/academic-year/:academicYearId/roll-no/:rollNo/cumulative-gpa`                             | Get Cumulative GPA             | new         |
| 31  | GET    | `/gradings/degree/:degreeId/from/:fromAcademicYearId/to/:toAcademicYearId/roll-no/:rollNo`           | Get Grading Document           | new         |
| 32  | GET    | `/gradings/degree/:degreeId/from/:fromAcademicYearId/to/:toAcademicYearId/roll-no/:rollNo/all-marks` | Get Mark Certificate           | new         |
| 33  | GET    | `/gradings/degree/:degreeId/academic-year/:academicYearId/roll-no/:rollNo/approval`                  | Get Approval Letter            | new         |
...
| 30  | GET    | `/gradings/academic-year/:academicYearId/major/:majorId/attendance-year/:attendanceYearId/remark/:remark` | Filter gradings by `academic-year`, `major`, `attendance-year` and `remark` | unfinished |
...
| NO. | Method | Routes           | Description            | Remark     |
| --- | ------ | ---------------- | ---------------------- | ---------- |
| 1   | GET    | `/users`         | Get all users          | unfinished | 
| 2   | POST   | `/users`         | Add new user           |            |
| 3   | POST   | `/users/auth`    | Check user credentials |            |
| 4   | GET    | `/users/:userId` | Get user by ID         | unfinished |
| 5   | PUT    | `/users/:userId` | Update user by ID      | unfinished |
| 6   | DELETE | `/users/:userId` | Delete user by ID      | unfinished |
